...
function documentWrite(){
    document.write("2교시 수업 중");
    document.write("<b>2교시</b> <br>수업 중<hr>")
...
function getInnerText(){
    // HTML 문서 내에서 아이디가 "test1" 인 요소를 얻어와서
    // test1 변수에 대입
...
function setInnerText(){
    // id가 'test1'인 요소를 얻어와서 test1 변수에 대입
    const test1 = document.getElementById("test1");

    // test1 변수에 새로운 내용을 작성해주자
...
function setInnerHTML1(){
    ...
    // test1 변수에 새로운 내용을 작성해주자
    test2.innerHTML = "innerHTML로 <br><b>변경</b>된 내용입니다."
}
