...
VALUES(900, '홍길동', '881126-1234567', 'hong_gd@kh.or.kr', 
		'01012341234', 'D1', 'J4', 'S6', 5000000);
...
-- * 조건절을 설정하지 않고 UPDATE 구문 실행 시 모든 행의 컬럼 값 변경된다!!
...
UPDATE EMPLOYEE2
SET (SALARY, BONUS) = (SELECT SALARY, BONUS FROM EMPLOYEE2
						WHERE EMP_NAME = '유재식')
WHERE EMP_NAME IN ('노옹철', '전형돈', '정중하', '하동운');
