...
INSERT INTO MEMBER (MEMBER_ID ,MEMBER_PWD ,MEMBER_NAME ,MEMBER_SSN)
			VALUES ('MEM03', 'PASS03', '멤버삼', '851126-2234567');
...
INSERT INTO MEMBER2 VALUES('이영희', 0012261234567);
INSERT INTO MEMBER2 VALUES('이나라', 9012261234567);
...
CREATE TABLE USER_USED_NN(
	USER_NO NUMBER NOT NULL, -- 사용자 번호 (무조건 존재해야 함 == NULL이면 안된다)
					--> 컬럼레벨 제약조건 설정 
	USER_ID VARCHAR2(20),
...
-- ORA-01400: NULL을 ("KH_KSH"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(KH_KSH.USER_ID_NAME_U)에 위배됩니다
...
CREATE TABLE USER_USED_PK(
	USER_NO NUMBER /*CONSTRAINT USER_NO_PK*/ /*PRIMARY KEY*/, -- 컬럼 레벨 PK 지정
					-- 제약조건명 생략 가능
	USER_ID VARCHAR2(20),
	USER_PWD VARCHAR2(30),
	USER_NAME VARCHAR2(30),
...
-- ORA-00001: 무결성 제약 조건(KH_KSH.USER_NO_PK)에 위배됩니다
-- == UNIQUE 오류와 같음
--> 기본키 중복으로 오류 발생

INSERT INTO USER_USED_PK
VALUES(NULL, 'user01', 'pass01', '유저일', 'M', '010-1234-5678', 'user01@kh.or.kr');
-- ORA-01400: NULL을 ("KH_KSH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다 
-- == NOT NULL 오류와 같음
--> 기본키가 NULL 이므로 오류
...
INSERT INTO USER_USED_PK2
VALUES(2, 'user01', 'pass02', '유저이', 'M', '010-1234-5678', 'user01@kh.or.kr');
-- ORA-00001: 무결성 제약 조건(KH_KSH.USERNO_USERID_PK)에 위배됩니다
-- 회원 번호와 아이디 둘 다 중복일 때만 제약조건 위배 에러 발생

INSERT INTO USER_USED_PK2
VALUES(NULL, 'user03', 'pass02', '유저이', 'M', '010-1234-5678', 'user01@kh.or.kr');
-- ORA-01400: NULL을 ("KH_KSH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
-- 컬럼명 : GRADE_NAME 한글 최대 10글자 널 허용 X
...
INSERT INTO USER_USED_FK
VALUES(3, 'user03', 'pass03', '유저삼', 'M', '010-1234-5678', 'user01@kh.or.kr', 40);
-- ORA-00001: 무결성 제약 조건(KH_KSH.SYS_C007448)에 위배됩니다
--> 참조 무결성 위배
...
WHERE GRADE_CODE = 10;
-- ORA-02292: 무결성 제약조건(KH_KSH.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
ROLLBACK; -- 현재 트랜젝션을 제거하고 마지막 COMMIT 상태로 돌아감
...
SELECT * FROM USER_GRADE2; -- 부모 테이블에서 삭제된거 확인(10 없어짐)
...
SELECT * FROM USER_GRADE3; -- 부모 테이블에서 삭제된거 확인(30 없어짐)
SELECT * FROM USER_USED_FK3; -- 30을 참조하던 자식 행 삭제 확인(종속 관계의 행이 모두 삭제됨)
...
INSERT INTO USER_USED_CHECK
VALUES(2, 'user01', 'pass01', '유저일', 'H', '010-1234-5678', 'user01@kh.or.kr');
-- ORA-02290: 체크 제약조건(KH_KSH.GENDER_CHECK)이 위배되었습니다
...
CREATE TABLE USER_TEST(
	...
	AGE NUMBER(3) CONSTRAINT CH_AGE CHECK(AGE>=20)
);
...
INSERT INTO USER_TEST VALUES (1, 'seha01', 'seha01', '931223-2234567', '여', '01012345678', '경기 안양시', 'N', '32');
INSERT INTO USER_TEST VALUES (2, 'user01', 'pass01', '911223-2234567', '여', '01012345678', '경기 과천시', 'N', '30');
INSERT INTO USER_TEST VALUES (3, 'user02', 'pass02', '921223-2234567', '여', '01012345678', '서울 관악구', 'N', '27');
INSERT INTO USER_TEST VALUES (4, 'user03', 'pass03', '931223-1234567', '남', '01012345678', '서울 서대문구', 'N', '25');
INSERT INTO USER_TEST VALUES (5, 'user04', 'pass04', '941223-2234567', '여', '01012345678', '경기 의왕시', 'N', '29');
...
CREATE TABLE EMPLOYEE_PIECE AS
SELECT EMP_ID, EMP_NAME, DEPT_TITLE, JOB_NAME
FROM EMPLOYEE 
LEFT JOIN DEPARTMENT ON(DEPT_CODE = DEPT_ID)
JOIN JOB USING(JOB_CODE);

SELECT * FROM EMPLOYEE_PIECE;
