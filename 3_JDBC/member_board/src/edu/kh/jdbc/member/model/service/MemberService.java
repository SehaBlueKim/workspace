...
//			 -> n개의 DAO에서 수행된 SQL문을 한번에 commit 하거나 rollback 할 예정
...
public class MemberService {
	...
	public int duplicateCheck(String memberId) throws Exception{
		// 1. Connection 객체 생성
		// -> JDBCTemplate에 작성된 getConnection() 메소드를 이용해서
		//	  커넥션 생성 후 얻어옴
	 ...
	 * @throws Exception
	 */
	public int updatePw(int memberNo, String currentPw, String updatePw) throws Exception{
		Connection conn = getConnection();
		
		int result = dao.updatePw(conn, memberNo, currentPw, updatePw);
