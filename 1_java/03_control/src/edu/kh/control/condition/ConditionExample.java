...
public class ConditionExample { // 예제 작성용 클래스
	...
	public void ex1() {
		...
		// 입력된 정수가 양수인지 아닌지 검사
		if(input > 0) { // input이 0보다 커서 조건식이 true인 경우에만 수행
