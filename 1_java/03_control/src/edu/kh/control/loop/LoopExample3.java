...
public class LoopExample3 {
	...
	public void ex2() {
		...
		int input = -1; // 입력 값 저장 + while문이 종료되지 않게하는 아무 값 대입하여 초기화
		int sum = 0; // 합계 저장용 변수
	...
	public void ex3() {
		...
		String menu = ""; //빈 문자열 -> 문자열을 이어쓰기 하더라도 아무런 영향이 없는 문자열
		
		while(input != 9) { // 9 입력 시 조건이 false가 되어 while문 종료됨
	...
	// do - while문 : 조건식 여부와 상관없이 최소 한 번은 수행
