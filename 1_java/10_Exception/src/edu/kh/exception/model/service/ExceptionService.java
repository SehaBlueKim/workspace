...
public class ExceptionService {
	...
	public void ex3() {
		...
		try {
			...
			// 강제로 NullPointerException 발생 시키기
			...
			// 서로 관계가 없는 예외는 순서 상관 없이 catch문에 작성하면 된다!
	...
	public void ex4() {
		...
		try {
			System.out.println(5 / 0); // ArithmeticExceoption 발생
		
		} catch(ArithmeticException e) {
			System.out.println("예외 처리됨");
			
			// 2) catch문 매개변수 활용
			// 매개변수 e : 예외 관련 정보 + 예외 관련 기능들을 가지고 있음
