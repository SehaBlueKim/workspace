...
public class StudentView { // 화면용 클래스
	...
	private void selectIndex() {
		...
		if(std == null) { // index 범위 초과 또는 학생 없음
			...
			System.out.println("수학점수 : " + std.getEng());
			System.out.println("영어점수 : " + std.getMath());
		}
	}
	...
	private void selectScore() {
		...
		System.out.println("점수를 조회할 학생 인덱스 입력 : ");
		int index = sc.nextInt();
	...
	private void updateStudent() {
		...
		Student std = service.selectIndex(index);
		// 이미 존재하는 service의 selectIndex(index) 메소드를 이용하여 학생이 있는지 확인
		...
		service.updateStudent(inputKor, inputEng, inputMath, std);
