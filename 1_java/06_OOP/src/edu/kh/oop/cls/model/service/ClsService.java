...
public class ClsService {
	...
	public void ex2() {
		/* static
		 * 1) 공유 메모리 영역(==정적 메모리 영역)이라고 한다
		 * 왜? 프로그램 시작 시 static이 붙은 코드들은 모두 static 영역에 생성되고,
		 * 		프로그램이 종료 될 때까지 사라지지 않는다. (움직임이 없다 = 정적이다)
		 * 		그리고 static 영역에 생성된 변수는 어디서든지 공유할 수 있다 (공유 메모리 영역)
		 * 
		 * 2) 사용 방법 : 클래스명.변수명
		 * */
		...
		System.out.println(std2.schoolName); // public
	...
	public void ex3() {
		...
		//		  u2가 참조하고 있는 User 객체의 필드 값이 모두 동일하다
		//		  왜? 같은 기본 생성자 User 객체를 생성했기 때문이다
		System.out.println("-------------------------------");
