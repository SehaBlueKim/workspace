...
public class MemberService { // 클래스
	...
	public String login() {
		...
		// 회원가입을 했는지 부터 확인
		// == memberInfo 가 객체를 참조하고 있는지 확인 (null인지 아닌지)
		...
		// 회원가입 정보(memberIfo가 참조하는 Member 객체)에서
		// 저장된 아이디, 비밀번호가
