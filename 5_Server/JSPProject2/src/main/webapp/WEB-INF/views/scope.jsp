...
<body>
	...
	<pre>
		...
		-> 현재 JSP에서만 사용 가능한 객체(Servlet에서는 못씀. 해당 페이지 내에서만 가능)
		...
		- [유지 범위] : 사이트 접속 ~ 브라우저 종료까지 | 세션 만료되기 전까지
	...
	<h2>\${XXXScope.key} : XXX 자리에 scope를 작성하면
		해당 scope에서 key가 일치하는 속성을 찾아서 출력해준다
	</h2>
